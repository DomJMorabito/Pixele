...
export const LoginErrorCode = {
    ...
    USER_NOT_CONFIRMED: 'USER_NOT_CONFIRMED',               // User has not completed their verification
    AUTHENTICATION_INCOMPLETE: 'AUTHENTICATION_INCOMPLETE', // User must complete MFA/SMS/Email authentication
